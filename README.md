...
STEP 1: REGISTER YOUR PROJECT FITBIT APP<br />
...
1.4. Fill in the online form for your project app (see screenshot of our completed form below).<br />
  1.4a. We used our lab website for the Application Website URL, Organization Website URL, Terms of Service URL, and Privacy Policy URL.<br />
  1.4b. Under "OAuth 2.0 Application Type" select "Client".<br />
  1.4c. In the text box under "Redirect URL" enter the following link https://www.google.com/ <br />
  1.4d. Under "Default Access Type" select "Read & Write".<br />
  1.4e. Click Save.<br />
...
STEP 2: SUBMIT REQUEST to FITBIT FOR INTRADAY DATA ACCESS.<br />
...
2.1. To submit an official request to Fitbit, go to https://dev.fitbit.com/build/reference/web-api/intraday-requests/ <br />
2.2. Complete the online form with the relevant information for your project.<br />
  2.2a. The following items on the form do not apply to your application if you are solely using it the purposes of data retreival and aggregation. Therefore, you can simply say "no" or "does not apply":<br />
...
2.3. Fitbit will be in contact with you to complete/confirm your request via the email address entered in the request form.<br />

STEP 3: CREATE YOUR FITBIT USER ACCESS TOKEN DATABASE<br />
...
STEP 4: GENERATE AUTHORIZATION URL LINK IN FITBIT APP<br />
...
\
4.1.Go to dev.fitbit.com.<br />
4.2.Log into the account under which your Fitbit app is registered (aka: administrator account).<br />
4.3.Go to Manage > Register an App > Manage My Apps > select your project app.<br />
4.4.At the bottom of this page, click the blue hyper-link titled "OAuth 2.0 tutorial page" (see example screenshot with the location of the hyperlink highlighted in yellow below).<br />
...
4.5.On the next page, you will see two sections: 1. Authorize and 2. Parse Response.<br />
...
\
4.7.After you are sure that the above URL is correctly saved, log out of your administrator Fitbit account.<br />
...
STEP 5: IMPLEMENT PARTICIPANT USER CONSENT TO FITBIT APP<br />

5.1.Go to fitbit.com.<br />
5.2.Log into the Fitbit user/participant's account.<br />
...
5.3.Return to where you pasted the authorization URL for this specific participant in your Fitbit User Access Token Database.<br />
...
5.5.Adjust the settings to select the amount of time that you want authorize your app access to the participant's Fitbit account.<br />
...
5.6.Select all the metrics that you want access to. (We authorized all metrics).<br />
5.7.Click "Allow".<br />
...
5.9. After you are sure that you have correctly saved this token, log out of the participant Fitbit account.<br />

*Again, before completing the STEP 6, ensure that you are logged OUT of the participant Fitbit account.<br />

STEP 6: GENERATE USER ACCESS TOKEN IN FITBIT APP (Used to connect FitaParser to Fitbit app)<br />

6.1.Go to fitbit.com.<br />
6.2.Log into your Fitbit administrator account.<br />
6.3.Open a new tab in this same browser.<br />
6.4.Go to dev.fitbit.com.<br />
6.5.Go to Manage > Register an App > Manage My Apps > select your project app.<br />
6.6.At the bottom of this page, click the blue hyper-link titled "OAuth 2.0 tutorial page".<br />
6.7.Now, copy/paste the Parse Response Input Token for the selected participant (saved in your Fitbit User Access Token Database) to the text box under the "2.Parse Response" section of this page (See example screenshot below).<br />
...
6.8.After pasting the URL, this will prompt a USER ID and TOKEN to generate underneath the text box (highlighted in yellow in the screenshot below).<br />
6.9.Copy/paste the USER ID and TOKEN under their respective columns in the appropriate participant row in your Fitbit User Access Token Database.<br />
